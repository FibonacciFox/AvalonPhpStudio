 ...
 * @property DayOfWeek $FirstDayOfWeek [description] 
 * @property bool $IsTodayHighlighted [description] 
 * @property IBrush $HeaderBackground [description] 
 * @property CalendarMode $DisplayMode [description] 
 * @property CalendarSelectionMode $SelectionMode [description] 
 * @property mixed $SelectedDate [description] 
 * @property-read SelectedDatesCollection $SelectedDates [description] 
 * @property DateTime $DisplayDate [description] 
 * @property mixed $DisplayDateStart [description] 
 * @property-read CalendarBlackoutDatesCollection $BlackoutDates [description] 
 * @property mixed $DisplayDateEnd [description] 
...
class UxCalendar {
 ...
 public static Event $SelectedDatesChangedEvent;

 public static Event $DisplayDateChangedEvent;

 public static Event $DisplayModeChangedEvent;
