 ...
 * @property-read IScrollable $Scroll [description] 
 * @property IList $SelectedItems [description] 
 * @property ISelectionModel $Selection [description] 
 * @property SelectionMode $SelectionMode [description] 
 * @property ItemVirtualizationMode $VirtualizationMode [description] 
 * @property bool $AutoScrollToSelectedItem [description] 
 * @property int $SelectedIndex [description] 
 * @property object $SelectedItem [description] 
 * @property bool $IsTextSearchEnabled [description] 
 * @property-read IItemContainerGenerator $ItemContainerGenerator [description] 
 * @property IEnumerable $Items [description] 
 * @property-read int $ItemCount [description] 
 * @property mixed $ItemsPanel [description] 
 * @property IDataTemplate $ItemTemplate [description] 
 * @property IItemsPresenter $Presenter [description] 
...
class UxListBox {
 ...
 public static Event $SelectionChangedEvent;
