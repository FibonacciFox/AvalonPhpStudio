 ...
 * @property string $GroupName [description] 
 * @property mixed $IsChecked [description] 
 * @property bool $IsThreeState [description] 
...
class UxRadioButton {
 ...
 public static Event $CheckedEvent;

 public static Event $UncheckedEvent;

 public static Event $IndeterminateEvent;
