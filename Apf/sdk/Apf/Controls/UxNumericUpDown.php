 ...
 * @property bool $AllowSpin [description] 
 * @property Location $ButtonSpinnerLocation [description] 
 * @property bool $ShowButtonSpinner [description] 
 * @property bool $ClipValueToMinMax [description] 
 * @property CultureInfo $CultureInfo [description] 
 * @property string $FormatString [description] 
 * @property float $Increment [description] 
 * @property bool $IsReadOnly [description] 
 * @property float $Maximum [description] 
 * @property float $Minimum [description] 
 * @property NumberStyles $ParsingNumberStyle [description] 
...
class UxNumericUpDown {
 ...
 public static Event $SpinnedEvent;

 public static Event $ValueChangedEvent;
