...
namespace Apf.Controls.Primitives
{
    ...
    public class UxToggleButton : UxButton
    {
        /// <summary>
        /// Defines the <see cref="IsChecked"/> property.
        /// </summary>
        public static readonly DirectProperty<UxToggleButton, bool?> IsCheckedProperty =
            AvaloniaProperty.RegisterDirect<UxToggleButton, bool?>(
                nameof(IsChecked),
                o => o.IsChecked,
                (o, v) => o.IsChecked = v,
                unsetValue: null,
        ...
        public static readonly StyledProperty<bool> IsThreeStateProperty =
            AvaloniaProperty.Register<UxToggleButton, bool>(nameof(IsThreeState));

        /// <summary>
        /// Defines the <see cref="Checked"/> event.
        /// </summary>
        public static readonly RoutedEvent<RoutedEventArgs> CheckedEvent =
            RoutedEvent.Register<UxToggleButton, RoutedEventArgs>(nameof(Checked), RoutingStrategies.Bubble);

        /// <summary>
        /// Defines the <see cref="Unchecked"/> event.
        /// </summary>
        public static readonly RoutedEvent<RoutedEventArgs> UncheckedEvent =
            RoutedEvent.Register<UxToggleButton, RoutedEventArgs>(nameof(Unchecked), RoutingStrategies.Bubble);

        /// <summary>
        /// Defines the <see cref="Unchecked"/> event.
        /// </summary>
        public static readonly RoutedEvent<RoutedEventArgs> IndeterminateEvent =
            RoutedEvent.Register<UxToggleButton, RoutedEventArgs>(nameof(Indeterminate), RoutingStrategies.Bubble);

        private bool? _isChecked = false;

        static UxToggleButton()
        {
            IsCheckedProperty.Changed.AddClassHandler<UxToggleButton>((x, e) => x.OnIsCheckedChanged(e));
        }
        ...
        /// <summary>
        /// Raised when a <see cref="UxToggleButton"/> is checked.
        /// </summary>
        ...
        /// <summary>
        /// Raised when a <see cref="UxToggleButton"/> is unchecked.
        /// </summary>
        ...
        /// <summary>
        /// Raised when a <see cref="UxToggleButton"/> is neither checked nor unchecked.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets whether the <see cref="UxToggleButton"/> is checked.
        /// </summary>
