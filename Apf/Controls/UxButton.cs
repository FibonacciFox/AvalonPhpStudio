...
namespace Apf.Controls
{
    ...
    public class UxButton : UxContentControl, ICommandSource, IStyleable
    {
        [PhpHidden]
        ...
        /// 
        /// </summary>
        private readonly IDictionary<string, EventHandler<RoutedEventArgs>> _events;
        
        /// <summary>
        /// Defines the <see cref="ClickMode"/> property.
        /// </summary>
        public static readonly StyledProperty<ClickMode> ClickModeProperty =
            AvaloniaProperty.Register<UxButton, ClickMode>(nameof(ClickMode));

        /// <summary>
        /// Defines the <see cref="Command"/> property.
        /// </summary>
        public static readonly DirectProperty<UxButton, ICommand> CommandProperty =
            AvaloniaProperty.RegisterDirect<UxButton, ICommand>(nameof(Command),
        ...
        public static readonly StyledProperty<KeyGesture> HotKeyProperty =
            HotKeyManager.HotKeyProperty.AddOwner<UxButton>();

        /// <summary>
        /// Defines the <see cref="CommandParameter"/> property.
        /// </summary>
        public static readonly StyledProperty<object> CommandParameterProperty =
            AvaloniaProperty.Register<UxButton, object>(nameof(CommandParameter));

        /// <summary>
        /// Defines the <see cref="IsDefaultProperty"/> property.
        /// </summary>
        public static readonly StyledProperty<bool> IsDefaultProperty =
            AvaloniaProperty.Register<UxButton, bool>(nameof(IsDefault));

        /// <summary>
        /// Defines the <see cref="IsCancelProperty"/> property.
        /// </summary>
        public static readonly StyledProperty<bool> IsCancelProperty =
            AvaloniaProperty.Register<UxButton, bool>(nameof(IsCancel));

        /// <summary>
        /// Defines the <see cref="Click"/> event.
        /// </summary>
        public static readonly RoutedEvent<RoutedEventArgs> ClickEvent =
            RoutedEvent.Register<UxButton, RoutedEventArgs>(nameof(Click), RoutingStrategies.Bubble);

        public static readonly StyledProperty<bool> IsPressedProperty =
            AvaloniaProperty.Register<UxButton, bool>(nameof(IsPressed));

        /// <summary>
        /// Defines the <see cref="Flyout"/> property
        /// </summary>
        public static readonly StyledProperty<FlyoutBase> FlyoutProperty =
            AvaloniaProperty.Register<UxButton, FlyoutBase>(nameof(Flyout));

        private ICommand _command = null!;
        private bool _commandCanExecute = true;
        private KeyGesture _hotkey = null!;
        
        public UxButton()
        {
            UpdatePseudoClasses(IsPressed);
            _events = new Dictionary<string, EventHandler<RoutedEventArgs>>();
        }
        ...
        static UxButton()
        {
            FocusableProperty.OverrideDefaultValue(typeof(UxButton), true);
            ...
            AccessKeyHandler.AccessKeyPressedEvent.AddClassHandler<UxButton>((lbl, args) => lbl.OnAccessKey(args));
        }
        /// <summary>
        ...
        ///  
        /// </summary>
        public void On(string eventTag , Closure  phpFunc)
        {
            _events[eventTag] = (o, r ) => phpFunc.__invoke(PhpValue.FromClass(o),PhpValue.FromClass(r));
            Click += _events[eventTag];
        ...
        protected override void OnPointerReleased(PointerReleasedEventArgs e)
        {
            ...
            if (IsPressed && e.InitialPressMouseButton == MouseButton.Left)
            {
                ...
                if (ClickMode == ClickMode.Release &&
                    this.GetVisualsAt(e.GetPosition(this)).Any(c => Equals(this, c) || this.IsVisualAncestorOf(c)))
                {
                    OnClick();
                }
            }
        ...
        {
            if (e.Sender is UxButton button)
            {
        ...
        {
            var button = e.Sender as UxButton;
            var isDefault = e.NewValue != null && (bool)e.NewValue;
        ...
        {
            var button = e.Sender as UxButton;
            var isCancel = e.NewValue != null && (bool)e.NewValue;
